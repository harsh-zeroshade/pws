...
export default function DisasterCommitteeEditor() {
  const [data,setData,save,saving,saved,err] = useContent("committee","disaster",{members:[{name:"Ms. Pooja Bose",role:"Head"},{name:"Mr. Navin Jain",role:"Member"},{name:"Ms. Pooja Suri",role:"Member"},{name:"Ms. Amandeep Kaur",role:"Member"},{name:"Ms. Shikha Yadav",role:"Member"},{name:"Mr. Rohit Thakur",role:"Member"},{name:"Mr. Sahil",role:"Member"},{name:"Ms. Suruchi Gupta",role:"Member"},{name:"Ms. Manvi Bhandari",role:"Member"},{name:"Mr. Arun Kumar",role:"Member"},{name:"Mr. Ravi Singh",role:"Member"},{name:"Mr. Rohit Prasad",role:"Member"},{name:"Ms. Monika",role:"Member"},{name:"Ms. Madhusha",role:"Member"}]});
  ...
  return (
    <AdminGuard><div style={{maxWidth:960}}>
      <PageHeader title="Disaster Management Committee" desc="Edit committee member names and roles."/>
